...
<head>
    <meta charset="UTF-8">
    <title>Dragon Age: The Veilguard - Cyber Game Arena</title>
    ...
    <style>
        *{
        ...
        .game-header{
            ...
            url('https://images.unsplash.com/photo-1506157786151-b8491531f063?q=80&w=1600') center/cover;
            display:flex;
...
<section>
    ...
    <div class="game-detail">
        ...
        <div class="detail-container">
            ...
            <div class="game-info">
                <h2>Dragon Age: The Veilguard - Huyền Thoại Trở Lại</h2>

                <p>
                    Dragon Age: The Veilguard là phần mới nhất của series Dragon Age được phát triển bởi BioWare. 
                    Trò chơi mang đến câu chuyện épic, nhân vật đa dạng, và lối chơi hành động hấp dẫn.
                </p>

                <p>
                    Dẫn dắt đội hình Veilguard để chống lại một mối đe dọa mới đối với Thedas. 
                    Gặp gỡ những đồng hành độc đáo, phát triển mối quan hệ, và xây dựng tinh thần đội nhóm. 
                    Mỗi quyết định của bạn sẽ ảnh hưởng đến câu chuyện và kết thúc của trò chơi.
                </p>

                <div class="specs">
                    <div class="spec-item">
                        <div class="spec-label">Nhà Phát Triển:</div>
                        <div class="spec-value">BioWare</div>
                    </div>
                    <div class="spec-item">
