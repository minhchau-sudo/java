...
<section>
    ...
    <div class="news-list">
        ...
        <div class="news-item">
            ...
            <div class="news-content">
                <div>
                    <div class="news-meta">📅 05/05/2026 | 👤 By TechGamer</div>
                    <h3>GPU RTX 5090 - Hiệu Năng Khủng Cho Gamers</h3>
                    <p>NVIDIA vừa ra mắt GPU RTX 5090 với hiệu năng gấp đôi RTX 4090. Card này được thiết kế riêng cho gaming 4K 240fps và AI processing. Giá dự kiến: $2000 USD.</p>
                </div>
                <a href="#" class="btn">Đọc Thêm</a>
            </div>
        </div>
        ...
        <div class="news-item">
            ...
            <div class="news-content">
                <div>
                    <div class="news-meta">📅 04/05/2026 | 👤 By IndieGames</div>
                    <h3>Top 5 Game Indie Hay Nhất Năm 2026</h3>
                    <p>Năm 2026 có rất nhiều game indie tuyệt vời. Từ các platformer, metroidvania, đến roguelikes, tất cả đều có. Một số game indie thậm chí còn tốt hơn cả AAA blockbuster.</p>
                </div>
                <a href="#" class="btn">Đọc Thêm</a>
            </div>
        </div>
        ...
        <div class="news-item">
            ...
            <div class="news-content">
                <div>
                    <div class="news-meta">📅 03/05/2026 | 👤 By GameDev</div>
                    <h3>Unreal Engine 6 - Công Nghệ Tương Lai Của Gaming</h3>
                    <p>Epic Games công bố Unreal Engine 6 với Real-Time Ray Tracing, AI-powered asset generation, và hỗ trợ metaverse. Đây là bước tiến lớn trong công nghệ game development.</p>
                </div>
                <a href="#" class="btn">Đọc Thêm</a>
            </div>
        </div>
        ...
        <div class="news-item">
            ...
            <div class="news-content">
                <div>
                    <div class="news-meta">📅 02/05/2026 | 👤 By MobileGamer</div>
                    <h3>Xu Hướng: Từ Mobile Cấu Hình Thấp Đến Console-Quality Games</h3>
                    <p>Các game mobile 2026 có chất lượng sánh với console. Công nghệ compression mới cho phép đồ họa AAA trên điện thoại với file size chỉ 1-2GB.</p>
                </div>
                <a href="#" class="btn">Đọc Thêm</a>
            </div>
        </div>
        ...
        <div class="news-item">
            ...
            <div class="news-content">
                <div>
                    <div class="news-meta">📅 01/05/2026 | 👤 By RPGLover</div>
                    <h3>Final Fantasy VII Remake: Rebirth - Release Date Announcement</h3>
                    <p>Square Enix chính thức công bố Final Fantasy VII Remake: Rebirth sẽ ra mắt vào Q4 2026. Phần mới sẽ có thế giới mở rộng và câu chuyện sâu sắc hơn.</p>
                </div>
                <a href="#" class="btn">Đọc Thêm</a>
            </div>
        </div>
