...
<head>
    <meta charset="UTF-8">
    <title>PUBG Mobile - Cyber Game Arena</title>
    ...
    <style>
        *{
        ...
        .game-header{
            ...
            url('https://images.unsplash.com/photo-1511512578047-dfb367046420?q=80&w=1600') center/cover;
            display:flex;
...
<section>
    ...
    <div class="game-detail">
        ...
        <div class="detail-container">
            ...
            <div class="game-info">
                <h2>PUBG Mobile - Game Sinh Tồn Hấp Dẫn</h2>

                <p>
                    PUBG Mobile là phiên bản di động của trò chơi sinh tồn hành động nổi tiếng PLAYERUNKNOWN'S BATTLEGROUNDS. 
                    Trò chơi được phát triển bởi Tencent Games và PUBG Corporation.
                </p>

                <p>
                    Tham gia trận chiến sinh tồn 100 người chơi trên một hòn đảo rộng lớn. Tìm kiếm vũ khí, trang bị và vật dụng để tồn tại. 
                    Hạ gục tất cả những kẻ thù của bạn và trở thành người cuối cùng sống sót!
                </p>

                <div class="specs">
                    <div class="spec-item">
                        <div class="spec-label">Nhà Phát Triển:</div>
                        <div class="spec-value">Tencent Games</div>
                    </div>
                    <div class="spec-item">
                        <div class="spec-label">Nền Tảng:</div>
                        <div class="spec-value">iOS, Android</div>
                    </div>
                    <div class="spec-item">
                        <div class="spec-label">Thể Loại:</div>
                        <div class="spec-value">Sinh Tồn, Hành Động, FPS</div>
                    </div>
                    <div class="spec-item">
                        <div class="spec-label">Giá Tiền:</div>
                        <div class="spec-value">Miễn Phí (Có IAP)</div>
                    </div>
                    <div class="spec-item">
